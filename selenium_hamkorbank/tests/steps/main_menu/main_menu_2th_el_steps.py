...
def step_second_el_of_main_menu(context):
    ...
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.BIZNES_UCHUN_BUTTON, text)
...
def step_submenu_of_second_el(context):
    ...
    main_page = MainPage(context.driver)
    main_page.do_hover(SideBarLocators.BIZNES_UCHUN_BUTTON)
    main_page.check_text_in_submenu_list(list_of_expected_text, SideBarLocators.SUBMENU_BIZNES_UCHUN)
