...
def step_fifth_el_of_main_menu(context):
    ...
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.MAIN_MENU_FIFTH, text)
...
def step_submenu_of_fifth_el(context):
    ...
    main_page = MainPage(context.driver)
    main_page.do_hover(SideBarLocators.MAIN_MENU_FIFTH)
    main_page.check_text_in_submenu_list(list_of_expected_text, SideBarLocators.MAIN_MENU_FIFTH_SUBMENU)
