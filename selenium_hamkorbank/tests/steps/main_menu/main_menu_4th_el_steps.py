...
def step_fourth_el_of_main_menu(context):
    ...
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.MOLIYAVIY_TASHKILOTLARGA_BUTTON, text)
...
def step_submenu_of_fourth_el(context):
    ...
    main_page = MainPage(context.driver)
    main_page.do_hover(SideBarLocators.MOLIYAVIY_TASHKILOTLARGA_BUTTON)
    main_page.check_text_in_submenu_list(list_of_expected_text, SideBarLocators.SUBMENU_MOLIYAVIY_TASHKILOTLARGA)
