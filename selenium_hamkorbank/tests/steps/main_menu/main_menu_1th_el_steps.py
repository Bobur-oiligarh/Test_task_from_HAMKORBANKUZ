...
def step_first_el_of_main_menu(context):
    ...
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.MAIN_MENU_FIRST, text)
...
def step_submenu_of_first_el(context):
    ...
    main_page = MainPage(context.driver)
    main_page.do_hover(SideBarLocators.MAIN_MENU_FIRST)
    main_page.check_text_in_submenu_list(list_of_expected_text, submenu_locator=SideBarLocators.MAIN_MENU_FIRST_SUBMENU)
