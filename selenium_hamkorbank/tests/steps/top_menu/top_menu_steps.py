...
def step_first_el_of_menu_1(context):
    ...
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.MENU_1_FIRST, text)
...
def step_second_el_of_menu_1(context):
    ...
    main_page = MainPage(context.driver)
    main_page.check_elem_visible_clickable_true_text(SideBarLocators.MENU_1_SECOND, text)
